...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public void onMeasure(int i, int i2) {
        ...
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(size, Declaration.MODULE_REFERENCE), View.MeasureSpec.makeMeasureSpec(size2, Declaration.MODULE_REFERENCE));
    }
    ...
    public void onActionViewExpanded() {
        if (!this.mExpandedInActionView) {
            ...
            this.mSearchSrcTextView.setImeOptions(imeOptions | Declaration.PROTECTED_ACCESS);
            this.mSearchSrcTextView.setText("");
            setIconified(false);
        }
    }
    ...
    private Intent createVoiceAppSearchIntent(Intent intent, SearchableInfo searchableInfo) {
        ...
        PendingIntent activity = PendingIntent.getActivity(getContext(), 0, intent2, Declaration.MODULE_REFERENCE);
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        private int getSearchViewTextMinWidthDp() {
            ...
            if (i < 600) {
                return (i < 640 || i2 < 480) ? ComponentConstants.TEXTBOX_PREFERRED_WIDTH : FullScreenVideoUtil.FULLSCREEN_VIDEO_ACTION_PAUSE;
            }
