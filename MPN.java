...
class MPN {
    ...
    public static int add_1(int[] iArr, int[] iArr2, int i, int i2) {
        ...
        for (int i3 = 0; i3 < i; i3++) {
            long j2 = j + (((long) iArr2[i3]) & 4294967295L);
            iArr[i3] = (int) j2;
            j = j2 >> 32;
        }
        return (int) j;
    ...
    public static int add_n(int[] iArr, int[] iArr2, int[] iArr3, int i) {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            long j2 = j + (((long) iArr2[i2]) & 4294967295L) + (4294967295L & ((long) iArr3[i2]));
            iArr[i2] = (int) j2;
            j = j2 >>> 32;
        }
        return (int) j;
    ...
    public static int mul_1(int[] iArr, int[] iArr2, int i, int i2) {
        ...
        long j2 = 0;
        for (int i3 = 0; i3 < i; i3++) {
            long j3 = j2 + ((((long) iArr2[i3]) & 4294967295L) * j);
            iArr[i3] = (int) j3;
            j2 = j3 >>> 32;
        }
        return (int) j2;
    ...
    public static void mul(int[] iArr, int[] iArr2, int i, int[] iArr3, int i2) {
        ...
        while (i4 < i5) {
            ...
            while (i6 < i3) {
                int i7 = i4 + i6;
                long j3 = j2 + ((((long) iArr5[i6]) & 4294967295L) * j) + (((long) iArr4[i7]) & 4294967295L);
                iArr4[i7] = (int) j3;
                j2 = j3 >>> 32;
                i6++;
                int i8 = i2;
    ...
    public static int divmod_1(int[] iArr, int[] iArr2, int i, int i2) {
        ...
        if ((j2 & 4294967295L) >= (((long) i2) & 4294967295L)) {
            j = 0;
        } else {
            iArr[i3] = 0;
            j = j2 << 32;
        ...
        while (i3 >= 0) {
            j = udiv_qrnnd((j & -4294967296L) | (((long) iArr2[i3]) & 4294967295L), i2);
            iArr[i3] = (int) j;
            i3--;
        }
        return (int) (j >> 32);
    ...
    public static int submul_1(int[] iArr, int i, int[] iArr2, int i2, int i3) {
        ...
        int i5 = 0;
        do {
            long j2 = (((long) iArr2[i4]) & 4294967295L) * j;
            int i6 = ((int) j2) + i5;
    ...
    public static void divide(int[] iArr, int i, int[] iArr2, int i2) {
        ...
        do {
            ...
            if (i6 == i7) {
                ...
                i3 = (int) udiv_qrnnd((((long) i6) << 32) + (((long) iArr3[i5 - 1]) & 4294967295L), i7);
            }
            if (i3 != 0) {
                int i8 = i5 - i4;
                long submul_1 = (((long) iArr3[i5]) & 4294967295L) - (((long) submul_1(iArr3, i8, iArr4, i4, i3)) & 4294967295L);
                while (true) {
                    long j = 0;
                    if (submul_1 == 0) {
                        break;
                    ...
                    while (i10 < i4) {
                        int i11 = i8 + i10;
                        long j2 = j + (((long) iArr3[i11]) & 4294967295L) + (((long) iArr4[i10]) & 4294967295L);
                        iArr3[i11] = (int) j2;
                        j = j2 >>> 32;
                        i10++;
                        i8 = i8;
